...
struct PhoneNumberFormatDisplayTests {
    ...
    func tenDigits() {
        #expect(PhoneNumberFormat.display("5551234567") == "(555) 123-4567")
    }

    @Test("Eleven digits starting with 1 keep the country code")
    func elevenDigits() {
        #expect(PhoneNumberFormat.display("15551234567") == "+1 (555) 123-4567")
        #expect(PhoneNumberFormat.display("+1 555 123 4567") == "+1 (555) 123-4567")
    }

    @Test("An already-grouped number survives a round trip")
    func alreadyFormatted() {
        #expect(PhoneNumberFormat.display("(555) 123-4567") == "(555) 123-4567")
    }
...
struct PhoneNumberFormatDialableTests {
    ...
    func stripsGrouping() {
        #expect(PhoneNumberFormat.dialable("(555) 123-4567") == "5551234567")
    }
    ...
    func keepsLeadingPlus() {
        ...
        #expect(PhoneNumberFormat.dialable("+1 (555) 123-4567") == "+15551234567")
    }
